		...
		<form id="Form1" method="post" runat="server">
			...
			<TABLE class="ordertable" id="cardList" style="Z-INDEX: 102; LEFT: 40px; WIDTH: 376px; POSITION: absolute; TOP: 272px; HEIGHT: 260px"
				...
				<TR>
					...
					<TD class="txtorderid" style="HEIGHT: 30px" align="center"><INPUT type="text" id="orderid" runat="server"></TD>
				...
				<TR>
					...
					<TD align="center"><INPUT type="text" size="20" id="cardnum" runat="server"></TD>
					<TD align="center"></TD>
				</TR>
				<TR>
					<TD style="FONT-WEIGHT: bold; WIDTH: 168px" align="left"><H3>Expiration Data</H3>
					</TD>
					<TD align="center"><INPUT type="text" size="20" id="expirationdate" runat="server"></TD>
					<TD align="center"></TD>
				</TR>
				<TR>
					<TD style="FONT-WEIGHT: bold; WIDTH: 168px" align="left"><H3>Card Holder Name</H3>
					</TD>
					<TD align="center"><INPUT type="text" size="20" id="Cardholdername" runat="server"></TD>
					<TD align="center"></TD>
				</TR>
				<TR>
			...
			<H3 align="center">
				<IMG style="Z-INDEX: 104; LEFT: 16px; POSITION: absolute; TOP: 16px" src="logo.gif"></H3>
			<H3></H3>
			<H3>&nbsp;</H3>
		</form>
	</body>
